...
lstm_classifier = ActionClassificationLSTM.load_from_checkpoint("/home/mcnlab/桌面/HAR using LSTM/lightning_logs/version_45/checkpoints/epoch=145-step=145.ckpt")
